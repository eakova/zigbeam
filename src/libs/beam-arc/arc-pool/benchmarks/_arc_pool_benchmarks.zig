...
//   src/libs/beam-arc/arc-pool/benchmarks/BENCHMARK_RESULTS_YYYY-MM-DD_HHMMSS.md
const MD_PATH_PREFIX = "src/libs/beam-arc/arc-pool/benchmarks/BENCHMARK_RESULTS_";
