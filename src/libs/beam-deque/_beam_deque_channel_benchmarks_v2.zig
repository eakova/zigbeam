...
// =============================================================================
// BeamDequeChannel Performance Benchmarks (V2 - Correct Usage Pattern)
// =============================================================================
//
...
fn bench8WorkersProducerConsumer() !void {
    const allocator = std.heap.c_allocator;
    const Channel = BeamDequeChannel(u64, 256, 8192);
...
pub fn main() !void {
    std.debug.print("\n╔═══════════════════════════════════════════════════════════╗\n", .{});
    std.debug.print("║  BeamDequeChannel Performance Benchmarks (V2)        ║\n", .{});
