...
//
// Input:  src/libs/loom/docs/datas/inputs/*.ppm
// Output: src/libs/loom/docs/datas/outputs/<name>_<transform>.ppm
...
const input_dir = "src/libs/loom/docs/datas/inputs";
const output_dir = "src/libs/loom/docs/datas/outputs";
