...
pub fn build(b: *std.Build) void {
    ...
    const mod = b.addModule("usage_sample", .{
    ...
    const exe = b.addExecutable(.{
        ...
        .root_module = b.createModule(.{
            ...
            // root module.
            .imports = &.{
                // Here "usage_sample" is the name you will use in your source code to
                // import this module (e.g. `@import("usage_sample")`). The name is
